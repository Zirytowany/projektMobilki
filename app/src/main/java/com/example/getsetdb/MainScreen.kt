...
class MainScreen : AppCompatActivity(), LocationListener {
    ...
    private fun getCurrentLocation() {
        if (checkPermissions()) {
            if (isLocationEnabled()) {
                ...
                Toast.makeText(this, "Włącz lokalizację", Toast.LENGTH_LONG).show()
    ...
    private fun sendGPS(id: String) {
        ...
        if (isOnline(this))
            Toast.makeText(this, "Połaczono z Internetem", Toast.LENGTH_SHORT).show()
        database.child(id).setValue(user).addOnSuccessListener {
            ...
            Toast.makeText(this, "Zapis się nie powiódł, spróbuj ponownie za chwilę", Toast.LENGTH_SHORT).show()
        }
    }

    private fun setText() {
        tv_longitude.setText("Wysokość: " + dlug)
        tv_latitude.setText("Szerokość: " + szer)
    }
